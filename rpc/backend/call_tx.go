...
import (
	...
	sdk "gitgithub.com/maiquanghiep/humansk/types"
	"github.cogithub.com/maiquanghiep/humansommon"
...
func (b *Backend) Resend(args evmtypes.TransactionArgs, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error) {
	...
	for _, tx := range pending {
		// FIXME does Resend api possible at all?  https://github.com/maiquanghiep/humanshumans/issues/905
