...
import (
	...
	"github.com/maiquanghiep/humans/rpc/types"
)

// PublicAPI offers and API for the transaction pool. It only operates on data that is non-confidential.
// NOTE: For more info about the current status of this endpoints see https://github.com/maiquanghiep/humanshumans/issues/124
