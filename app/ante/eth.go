...
import (
	...
	"github.com/maiquanghiep/humanshumans/x/evm/keeper"
	"github.com/maiquanghiep/humanshumans/x/evm/statedb"
...
func (egcd EthGasConsumeDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (sdk.Context, error) {
	...
	if ctx.IsReCheckTx() {
		...
		// https://github.com/maiquanghiep/humanshumans/issues/1554
